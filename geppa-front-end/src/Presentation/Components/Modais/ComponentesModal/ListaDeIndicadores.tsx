...
interface ListaDeIndicadoresProps {
    ...
    onUpdate: (indicadores: Indicador[]) => void;
    edicao?: boolean;
}

const ListaDeIndicadores: React.FC<ListaDeIndicadoresProps> = ({ indicadoresIniciais = [], onUpdate, edicao = false }) => {
    ...
    return (
        <div className='mx-md-5 '>
            ...
            <div className="d-flex justify-content-between align-items-center">
                ...
                {!edicao && (
                    <button onClick={() => openModalIndicadores(null)}
                            className="btn-adicionar-indicador fw-bold fs-6 py-2 px-3 rounded">
                        Adicionar Indicador
                    </button>
                )}
            </div>
